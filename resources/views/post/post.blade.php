...
<body>
    <p><a class="btn-create"  href="{{route('post.create')}}">Create Post</a></p>
    <table >
        <thead>
            <tr>
                <th>PostID</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a class="btn-show" href="{{ route('post.show', $post->id) }}">Show</a></td>
                <td><a class="btn-edit" href="{{ route('post.edit', $post->id) }}">Edit</a></td>
                <td> 
